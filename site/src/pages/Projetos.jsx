  ...
  const projetos = [
    {
      ...
      local: "Rua René Bittencourt nº 371 Distrito Industrial de Santa Cruz.",
      data: "Dez/2015",
    ...
    },
    {
      ...
      local: "A. João XXIII - Distrito Industrial de Santa Cruz.",
      data: "Dez/2014",
    ...
    },
    {
      ...
      destaque: false,
      servicos: [
        "Ampliação e integração dos sistemas de detecção e alarme de incêndios do Centro Administrativo",
        "Sistema de Detecção e alarme de incêndio",
        "Combate por FM-200",
        "Levantamento de campo",
        "Projeto básico",
    ...
    },
    {
      ...
      local: "Avenida NISSAN, 1500c – Portão 5 - polo industrial - Resende – Rio de Janeiro",
      data: "OUT/2018",
      ...
      destaque: false,
      servicos: [
        "Adequação da sala de gerador e tanques diesel conforme aditamento 0001/2015",
        "Portas corta fogo",
        "Combate por LGE",
    ...
    },
    {
      ...
      descricao: "Unidade: Galpão de resíduos - 1300 m²",
      ...
      servicos: [
        ...
        "Iluminação de Emergência",
        "Sistema de Detecção e alarme de incêndio",
        "Sistema de hidrantes e mangotinhos e acessórios",
        "Levantamento de campo",
        "Projeto básico",
        "Projeto executivo",
        "Memorial descritivo",
    ...
    },
    {
      ...
      local: "AV. Rio Branco 219 - Rio de Janeiro – RJ",
      data: "OUT/2018",
      ...
      servicos: [
        ...
        "Levantamento de campo detalhado para verificar situação do sistema",
        "Verificação da necessidade de substituição de equipamentos junto ao cliente",
        "Programação e ajuste do sistema para sanar falhas de software ou falhas de equipamentos",
        "Teste e diagnóstico dos equipamentos via software da central com leitura de valores analógicos",
        "Reparo corretivo nos sistemas de aspiração com reposição do fluido destilado do sistema de detecção",
        "Teste funcional com ativação das sirenes do sistema para verificação da atuação das mesmas",
        "Emissão de relatório final com descrição de falhas e suas correções ou situação a ser resolvida posteriormente",
    ...
    },
    {
      ...
      local: "Av. Rio Branco, nº 1, sala 2002, Centro RJ",
      data: "05/2016",
